...
public class MainActivity extends Activity {
    ...
    public void getFormWidgets() {
        ...
        adapter = new ArrayAdapter<JobInWeek>(this,
                android.R.layout.simple_list_item_1, arrJob);
    ...
    private class MyListViewEvent implements OnItemClickListener,
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            ...
            Toast.makeText(MainActivity.this, arrJob.get(arg2).getDescription(),
    ...
    public void processAddJob() {
        ...
        JobInWeek job = new JobInWeek(title, description, dateFinish,
                hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
